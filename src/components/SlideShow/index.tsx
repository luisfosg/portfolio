      ...
      <blockquote className="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/CW_6yBaJptC/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style={
        ...
        <div style={{
          ...
          <a href="https://www.instagram.com/p/CW_6yBaJptC/?utm_source=ig_embed&amp;utm_campaign=loading" style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}> <div style={{ backgroundColor: '#F4F4F4', borderRadius: '50%', height: '40px', marginRight: '14px', width: '40px' }}></div>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              <div style={{ backgroundColor: '#F4F4F4', borderRadius: '4px', height: '14px', marginBottom: '6px', width: '100px' }}>
            </div> <div style={{ backgroundColor: '#F4F4F4', borderRadius: '4px', height: '14px', width: '60px' }}></div></div>
            </div>
            ...
            <div style={{ paddingTop: '8px' }}>
              <div style={{ color: '#3897f0', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', lineHeight: '18px' }}>View this post on Instagram</div>
            </div>
          ...
          <p style={
            ...
            A post shared by Coding With LuisFOsG (@codingwithluisfosg)
            </a>
          </p>
        </div>
      </blockquote>
